...
-- ft.getContWave()
 --print(ft.getWaveData(10).Flow)
 
 
 
--ft.setCPAP__mbar(7) 
--print(ft.getCPAP())
--ft.setPManuel__mbar(5)
--print(ft.getPManuel())
--ft.setTherapyFlow__lpm(1)
  --ft.setITime__sec(1)
   --ft.setBPM__bpm(40) 
--ft.getContWave()
--[[
...
--[[
local breathData = ft.getBTB(1)
require 'pl.pretty'.dump(breathData)

print (breathData[1].PEEP)
]]
------------------------------
------------------------------
